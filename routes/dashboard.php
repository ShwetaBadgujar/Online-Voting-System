    ...
    <body background="kj.jpg">
            ...
            <div id="mainSection">
                <div id="profileSection">
                    <center><img style="border-radius:50px;"src="../uploads/<?php echo $data['photo']?>" height="100" width="100"></center><br>
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <img style="float: right;border-radius:50px" src="../uploads/<?php echo $groups[$i]['photo']?>" height="80" width="80">
                        ...
                        ?>
                            <div style="border-bottom: 5px solid #000000; margin-bottom: 10px">
